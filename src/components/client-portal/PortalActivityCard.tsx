      ...
      <div className="p-4 space-y-2">
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0">
            ...
            <p className="text-sm font-medium text-[var(--wl-text-primary)] truncate">{activity.title}</p>
          </div>
        ...
        {!expanded && (
          <p className="text-[11px] text-[var(--wl-text-placeholder)] pl-6">{fmtDate(activity.startDate)}</p>
        )}
      </div>
      ...
      {expanded && (
        <div className="px-4 pb-4 space-y-3 border-t border-[var(--wl-border)] pt-3">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            {activity.endDate && (
              <div className="bg-[var(--wl-hover)] rounded-lg p-2.5">
                <p className="text-[10px] text-[var(--wl-text-placeholder)] uppercase tracking-wider mb-0.5">Fin</p>
          ...
          {activity.createdBy && (
            <div className="flex items-center gap-2 pt-1">
              <User className="h-3.5 w-3.5 text-[var(--wl-text-placeholder)]" />
