...
export default function TaskForm({ open, onOpenChange, task, isManager = false, onSuccess }: TaskFormProps) {
  ...
  useEffect(() => {
    if (task) {
      ...
      setStartDate(undefined); setDueDate(undefined); setAssigneeIds([]); setClientId('');
    }
