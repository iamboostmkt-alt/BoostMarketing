  ...
  return (
    <AuthProvider>
      ...
      <TooltipProvider delayDuration={0}>
        <SidebarProvider>
          <div className="flex h-screen overflow-hidden" style={{ background: "radial-gradient(ellipse at 100% 100%, #3b1a6e 0%, #1a0a35 30%, #0a0a0a 65%)" }}>
            {/* Sidebar */}
            <AppSidebar />
            ...
            <div className="flex flex-1 flex-col min-w-0">
              ...
              <main className="flex-1 overflow-hidden flex flex-col">
                <div className="flex-1 overflow-y-auto custom-scrollbar" style={{ background: "radial-gradient(ellipse at 100% 100%, #3b1a6e 0%, #1a0a35 30%, #0a0a0a 65%)" }}>
